...
class FavoritePokemon : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Thread {
                PokemonDatabase.getInstance(applicationContext).pokemonDao().readPokemonFromName(navbarTitle).forEach {
                pokemon->
                fpokeImage.setImageBitmap(Utils.getImage(pokemon.image))
